...
public class AddDoubleOperatorTest {
    ...
    public void addDoubleAndDoubleValuesTest() {
        ...
        IBinaryOperator<Double> adder = new Adder<Double, NumberDouble>(new NumberDouble(value1),
    ...
    public void addDoubleAndAdderValuesTest() {
        ...
        IBinaryOperator<Double> rightOperand = new Adder<Double, NumberDouble>(new NumberDouble(value2),
                new NumberDouble(value3));
        IBinaryOperator<Double> adder = new Adder<Double, NumberDouble>(new NumberDouble(value1), rightOperand,
    ...
    public void addAdderAndDoubleValuesTest() {
        ...
        expected = value1 + value2 + value3;
        IBinaryOperator<Double> leftOperand = new Adder<Double, NumberDouble>(new NumberDouble(value1),
                new NumberDouble(value2));
        IBinaryOperator<Double> adder = new Adder<Double, NumberDouble>(leftOperand, new NumberDouble(value3),
                new NumberDoubleFactory());
        assertEquals(expected, adder.solve().doubleValue(), 0);
    }
    ...
    public void addAdderAndAdderValuesTest() {
        ...
        IBinaryOperator<Double> leftOperand = new Adder<Double, NumberDouble>(new NumberDouble(value1),
                new NumberDouble(value2));
        IBinaryOperator<Double> rightOperand = new Adder<Double, NumberDouble>(new NumberDouble(value3),
                new NumberDouble(value4));
        IBinaryOperator<Double> adder = new Adder<Double, NumberDouble>(leftOperand, rightOperand,
                new NumberDoubleFactory());
        assertEquals(expected, adder.solve().doubleValue(), 0);
    }
