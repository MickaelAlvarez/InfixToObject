...
public class MultiplyFloatOperatorTest {
    ...
    public void multiplyFloatAndFloatValuesTest() {
        ...
        IBinaryOperator<Float> multiplier = new Multiplier<Float, NumberFloat>(new NumberFloat(value1),
    ...
    public void multiplyFloatAndMultiplierValuesTest() {
        ...
        IBinaryOperator<Float> rightOperand = new Multiplier<Float, NumberFloat>(new NumberFloat(value2),
                new NumberFloat(value3));
        IBinaryOperator<Float> multiplier = new Multiplier<Float, NumberFloat>(new NumberFloat(value1), rightOperand,
    ...
    public void multiplyMultiplierAndFloatValuesTest() {
        float value1 = 2.123f, value2 = 2.123f, value3 = 2.123f, expected;
        expected = (value1 * value2) * value3;
        IBinaryOperator<Float> leftOperand = new Multiplier<Float, NumberFloat>(new NumberFloat(value1),
                new NumberFloat(value2));
        IBinaryOperator<Float> multiplier = new Multiplier<Float, NumberFloat>(leftOperand, new NumberFloat(value3),
                new NumberFloatFactory());
        assertEquals(expected, multiplier.solve().floatValue(), 0);
    }
    ...
    public void multiplyMultiplierAndMultiplierValuesTest() {
        ...
        IBinaryOperator<Float> leftOperand = new Multiplier<Float, NumberFloat>(new NumberFloat(value1),
                new NumberFloat(value2));
        IBinaryOperator<Float> rightOperand = new Multiplier<Float, NumberFloat>(new NumberFloat(value3),
                new NumberFloat(value4));
        IBinaryOperator<Float> multiplier = new Multiplier<Float, NumberFloat>(leftOperand, rightOperand,
                new NumberFloatFactory());
        assertEquals(expected, multiplier.solve().floatValue(), 0);
    }
