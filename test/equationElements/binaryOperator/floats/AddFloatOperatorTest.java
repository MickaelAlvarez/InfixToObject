...
public class AddFloatOperatorTest {
    ...
    public void addIntegerAndAdderValuesTest() {
        ...
        IBinaryOperator<Float> rightOperand = new Adder<Float, NumberFloat>(new NumberFloat(value2),
                new NumberFloat(value3));
        IBinaryOperator<Float> adder = new Adder<Float, NumberFloat>(new NumberFloat(value1), rightOperand,
    ...
    public void addAdderAndIntegerValuesTest() {
        ...
        expected = value1 + value2 + value3;
        IBinaryOperator<Float> leftOperand = new Adder<Float, NumberFloat>(new NumberFloat(value1),
                new NumberFloat(value2));
        IBinaryOperator<Float> adder = new Adder<Float, NumberFloat>(leftOperand, new NumberFloat(value3),
                new NumberFloatFactory());
        assertEquals(expected, adder.solve().floatValue(), 0);
    }
    ...
    public void addAdderAndAdderValuesTest() {
        ...
        IBinaryOperator<Float> leftOperand = new Adder<Float, NumberFloat>(new NumberFloat(value1),
                new NumberFloat(value2));
        IBinaryOperator<Float> rightOperand = new Adder<Float, NumberFloat>(new NumberFloat(value3),
                new NumberFloat(value4));
        IBinaryOperator<Float> adder = new Adder<Float, NumberFloat>(leftOperand, rightOperand,
                new NumberFloatFactory());
        assertEquals(expected, adder.solve().floatValue(), 0);
    }
