...
public class SubtractorIntegerOperatorTest {
    ...
    public void subtractIntegerAndIntegerValuesTest() {
        ...
        IBinaryOperator<Integer> subtractor = new Subtractor<Integer, NumberInteger>(new NumberInteger(value1),
    ...
    public void subtractIntegerAndSubtractorValuesTest() {
        ...
        IBinaryOperator<Integer> rightOperand = new Subtractor<Integer, NumberInteger>(new NumberInteger(value2),
                new NumberInteger(value3));
        IBinaryOperator<Integer> adder = new Subtractor<Integer, NumberInteger>(new NumberInteger(value1), rightOperand,
    ...
    public void subtractSubtractorAndIntegerValuesTest() {
        ...
        expected = (value1 - value2) - value3;
        IBinaryOperator<Integer> leftOperand = new Subtractor<Integer, NumberInteger>(new NumberInteger(value1),
                new NumberInteger(value2));
        IBinaryOperator<Integer> adder = new Subtractor<Integer, NumberInteger>(leftOperand, new NumberInteger(value3),
                new NumberIntegerFactory());
        assertEquals(expected, adder.solve().intValue());
    }
    ...
    public void addAdderAndAdderValuesTest() {
        ...
        IBinaryOperator<Integer> leftOperand = new Subtractor<Integer, NumberInteger>(new NumberInteger(value1),
                new NumberInteger(value2));
        IBinaryOperator<Integer> rightOperand = new Subtractor<Integer, NumberInteger>(new NumberInteger(value3),
                new NumberInteger(value4));
        IBinaryOperator<Integer> adder = new Subtractor<Integer, NumberInteger>(leftOperand, rightOperand,
                new NumberIntegerFactory());
        assertEquals(expected, adder.solve().intValue());
    }
