...
public class AddIntegerOperatorTest {
    ...
    public void addIntegerAndIntegerValuesTest() {
        ...
        IBinaryOperator<Integer> adder = new Adder<Integer, NumberInteger>(new NumberInteger(value1),
    ...
    public void addIntegerAndAdderValuesTest() {
        ...
        IBinaryOperator<Integer> rightOperand = new Adder<Integer, NumberInteger>(new NumberInteger(value2),
                new NumberInteger(value3));
        IBinaryOperator<Integer> adder = new Adder<Integer, NumberInteger>(new NumberInteger(value1), rightOperand,
    ...
    public void addAdderAndIntegerValuesTest() {
        ...
        expected = value1 + value2 + value3;
        IBinaryOperator<Integer> leftOperand = new Adder<Integer, NumberInteger>(new NumberInteger(value1),
                new NumberInteger(value2));
        IBinaryOperator<Integer> adder = new Adder<Integer, NumberInteger>(leftOperand, new NumberInteger(value3),
                new NumberIntegerFactory());
        assertEquals(expected, adder.solve().intValue());
    }
    ...
    public void addAdderAndAdderValuesTest() {
        ...
        IBinaryOperator<Integer> leftOperand = new Adder<Integer, NumberInteger>(new NumberInteger(value1),
                new NumberInteger(value2));
        IBinaryOperator<Integer> rightOperand = new Adder<Integer, NumberInteger>(new NumberInteger(value3),
                new NumberInteger(value4));
        IBinaryOperator<Integer> adder = new Adder<Integer, NumberInteger>(leftOperand, rightOperand,
                new NumberIntegerFactory());
        assertEquals(expected, adder.solve().intValue());
    }
